...
public class BlockChainTest
{
    ...
    public void BlockChainExecutionTest()
    {
        ...
        output.WriteLine("Checking if two blocks are valid");
        try { 
            blockChain.LastBlock.Verify(); 
        ...
        // Verify last block
        try { 
            blockChain.GenesisBlock.Verify(); 
            output.WriteLine("\tGenesis block is valid"); 
        }
        catch { 
            output.WriteLine("\tGenesis block is not valid"); 
        }
